...
The default Logwiz deployment includes `otel-logs-v0_9` — a standard OpenTelemetry logs index created by default. It maps directly to the [OpenTelemetry Log Data Model](https://opentelemetry.io/docs/specs/otel/logs/data-model/) and is ready to use without any configuration.
...
- [Send logs](/send-logs) to start ingesting data into any index.
