...
Until you save explicit settings for an index, Logwiz uses these OpenTelemetry-friendly defaults to render its rows and detail drawer:

| Logwiz field    | Default path                      |
| --------------- | --------------------------------- |
