...
<Step title="Create the admin account">
  ...
  <Step title="Create an ingest token">
    ...
    1. In the top navigation, go to **Administration → Tokens**.
    2. Click **Create Token**, give it a name, and pick the index it will write to.
    3. Click the eye icon on the token row to reveal and copy the value.
