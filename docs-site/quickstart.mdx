...
<Steps>
  ...
  <Step title="Create the admin account">
    Open [http://localhost:8282](http://localhost:8282) in your browser. On first boot, Logwiz redirects you to the setup wizard at `/auth/setup-admin`. Enter your desired admin credentials and submit the form. You will be signed in automatically after setup completes.
  </Step>
