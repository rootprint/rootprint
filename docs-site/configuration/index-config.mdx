...
<Note>
	Logwiz syncs available indexes from Quickwit on server startup. If you add a new index to Quickwit
	while Logwiz is running, restart the Logwiz container to pick it up.
</Note>
