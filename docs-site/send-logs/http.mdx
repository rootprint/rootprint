...
<Steps>
  <Step title="Pick the target index">
    Decide which Quickwit index you'll write to. The default OTEL index is `otel-logs-v0_9` — see [Indexes](/indexes) for its schema, or create a custom index in Quickwit first.
  </Step>
