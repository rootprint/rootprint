...
<Steps>
  ...
  <Step title="Choose your target index">
    Pick the Quickwit index you want to write to. If you are using the default setup, that is `otel-logs-v0_9`. See [Indexes](/indexes) to learn about the built-in index and custom indexes.
  </Step>
