...
<Tip>
	Logwiz targets `otel-logs-v0_9` for its bundled OpenTelemetry integration. Older Quickwit
	versions ship `otel-logs-v0_7` as the default OTEL index — check your Quickwit metastore for the
	exact index ID before pointing a token at it.
</Tip>
