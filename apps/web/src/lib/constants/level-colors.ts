/**
 * Canonical level → hex color map; single source of truth for level coloring.
 * Hexes are OKLCH-equalized at L≈0.62, C≈0.18 so all levels carry equal perceptual
