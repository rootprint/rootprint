		...
		return [
			{
				...
				body:
					'Save this next to your docker-compose.yaml. The endpoint and token are prefilled.',
			...
			},
			{
				...
				body:
					'Run any short-lived container — Vector picks up its stdout and forwards it to Logwiz.',
